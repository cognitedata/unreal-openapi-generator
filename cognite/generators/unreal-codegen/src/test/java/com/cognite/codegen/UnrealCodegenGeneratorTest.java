 ...
 * 1) Set a break point in UnrealCodegenGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class UnrealCodegenGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("unreal-codegen") // use this codegen library
              ...
              .setOutputDir("out/unreal-codegen"); // output directory
