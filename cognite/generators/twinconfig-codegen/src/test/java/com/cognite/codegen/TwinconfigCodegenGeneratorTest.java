 ...
 * 1) Set a break point in TwinconfigCodegenGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class TwinconfigCodegenGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("twinconfig-codegen") // use this codegen library
              ...
              .setOutputDir("out/twinconfig-codegen"); // output directory
