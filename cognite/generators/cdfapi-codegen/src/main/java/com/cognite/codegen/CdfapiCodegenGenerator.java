...
public class CdfapiCodegenGenerator extends AbstractCppCodegen implements CodegenConfig {
  ...
  public CdfapiCodegenGenerator() {
    ...
    outputFolder = "generated-code/cdfapi-codegen";
    /**
  ...
  public String getHelp() {
    return "Generates a cdfapi-codegen client library.";
  }
  ...
  public String modelFileFolder() {
    ...
    protected void addImport(CodegenModel m, String type) {
        ...
        if ( m.classFilename.equals( toModelFilename(type) ) )
            return;
